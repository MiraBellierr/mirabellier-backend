...
const ELEMENT_EFFECTIVENESS = {
  Fire:  { Fire: 1, Water: 0.5, Earth: 10, Wind: 1, Light: 1, Dark: 1 },
  Water: { Fire: 10, Water: 1, Earth: 0.5, Wind: 1, Light: 1, Dark: 1 },
  Earth: { Fire: 0.5, Water: 10, Earth: 1, Wind: 1, Light: 1, Dark: 1 },
  Wind:  { Fire: 1, Water: 1, Earth: 1, Wind: 1, Light: 10, Dark: 0.5 },
  Light: { Fire: 1, Water: 1, Earth: 1, Wind: 0.5, Light: 1, Dark: 10 },
  Dark:  { Fire: 1, Water: 1, Earth: 1, Wind: 10, Light: 0.5, Dark: 1 },
};
  ...
  },
  {
    ...
    consumables: [
      ...
      },
      {
        ...
        consumableEffect: { kind: "draw_bonus_chance", pct: 10, wins: 20 },
      },
    ],
    materials: [
      {
