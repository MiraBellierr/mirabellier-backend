...
const ELEMENT_EFFECTIVENESS = {
  Fire:  { Fire: 1, Water: 0.5, Earth: 1.5, Wind: 1, Light: 1, Dark: 1 },
  Water: { Fire: 1.5, Water: 1, Earth: 0.5, Wind: 1, Light: 1, Dark: 1 },
  Earth: { Fire: 0.5, Water: 1.5, Earth: 1, Wind: 1, Light: 1, Dark: 1 },
  Wind:  { Fire: 1, Water: 1, Earth: 1, Wind: 1, Light: 1.5, Dark: 0.5 },
  Light: { Fire: 1, Water: 1, Earth: 1, Wind: 0.5, Light: 1, Dark: 1.5 },
  Dark:  { Fire: 1, Water: 1, Earth: 1, Wind: 1.5, Light: 0.5, Dark: 1 },
};
    ...
    consumables: [
      {
        ...
        consumableEffect: { kind: "crit_chance", pct: 20, fights: 750 },
      },
      {
        id: "oath_ribbon",
        name: "Oath Ribbon",
        sprite: { sheet: "game.png", row: 10, col: 10, size: 32 },
        consumableEffect: { kind: "guard_boost", pct: 15, fights: 750 },
      },
      {
        id: "treasure_cache",
        name: "Arcane Mirror",
...
const MAX_DAILY_OPPONENT_COUNT = 10;
